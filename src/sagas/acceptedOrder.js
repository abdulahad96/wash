...
import {success, failure} from '../actions/acceptedOrder';
import {Accepted_order} from '../config/WebServices';
...
//   console.log("paylllllllllllll",payload)
  return ApiSauce.postWithToken(Accepted_order, payload, token);
}
// ​function callRequest(data) {
...
function* watchRequest() {
  while (true) {
    // a++;
    const {payload} = yield take(types.ACCEPTED_ORDER.REQUEST);
